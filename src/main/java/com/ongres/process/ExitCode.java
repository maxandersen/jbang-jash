...
/**
 * This is an opinionated list of exit codes created starting from
 * https://tldp.org/LDP/abs/html/exitcodes.html#AEN23647
 */
public class ExitCode {
	...
	/**
	 * Catchall for general errors. Example:
	 * 
	 * <pre>
	 * let "var1 = 1/0"
	 * </pre>
	...
	/**
	 * Misuse of shell builtins (according to Bash documentation). Example:
	 * 
	 * <pre>
	 * empty_function() {
	 * }
	 * </pre>
	 * 
	 * Missing keyword or command, or permission problem (and diff return code on a
	 * failed binary file comparison).
	 */
	public static final int SHELL_MISUSE = 2;

	/**
	 * Command invoked cannot execute. Example:
	 * 
	 * <pre>
	 *   /dev/null
	 * </pre>
	...
	/**
	 * Invalid argument to exit. Example:
	 * 
	 * <pre>
	 * exit 3.14159
	 * </pre>
	...
	/**
	 * Exit status out of range. Example:
	 * 
	 * <pre>
	 * exit - 1
	 * </pre>
